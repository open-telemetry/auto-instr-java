...
include(":instrumentation:couchbase:couchbase-common-2.0:testing")
...
include(":instrumentation:jsf:jsf-3.0:javaagent")
include(":instrumentation:jsf:jsf-3.0:testing")
include(":instrumentation:jsf:jsf-2.3:javaagent")
include(":instrumentation:jsf:jsf-2.3:testing")
...
include(":instrumentation:ktor:ktor-common-1.0:library")
...
include(":instrumentation:lettuce:lettuce-common-5.0:library")
...
include(":instrumentation:log4j:log4j-context-data:log4j-context-data-common-2.7:testing")
...
include(":instrumentation:mongo:mongo-common-3.1:testing")
...
include(":instrumentation:netty:netty-common-3.8:library")
...
include(":instrumentation:quarkus-resteasy-reactive-1.11:common-testing")
include(":instrumentation:quarkus-resteasy-reactive-1.11:javaagent")
include(":instrumentation:quarkus-resteasy-reactive-1.11:quarkus2-testing")
include(":instrumentation:quarkus-resteasy-reactive-1.11:quarkus3-testing")
...
include(":instrumentation:spring:spring-cloud-gateway:spring-cloud-gateway-common-2.0:testing")
...
include(":instrumentation:spring:spring-data:spring-data-common-1.8:testing")
...
include(":instrumentation:xxl-job:xxl-job-common-2.1.2:javaagent")
include(":instrumentation:xxl-job:xxl-job-common-2.1.2:testing")
